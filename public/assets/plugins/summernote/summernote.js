...
(function (factory) {
  ...
  var dom = (function () {
     ...
     *
     * assert if a node contains a "note-styletag" className,
  ...
  /**
   * @className Create a virtual table to create what actions to do in change.
  ...
  */
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.fontname', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<span className="note-current-fontname"/> ' + ui.icon(options.icons.caret, 'span'),
      ...
      context.memo('button.fontsize', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: '<span className="note-current-fontsize"/>' + ui.icon(options.icons.caret, 'span'),
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div className="form-group">' +
      ...
      var footer = '<button href="#" className="btn btn-primary note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div className="form-group note-group-select-from-files">' +
                 ...
                 '</div>';
      var footer = '<button href="#" className="btn btn-primary note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div className="form-group row-fluid">' +
          '<label>' + lang.video.url + ' <small className="text-muted">' + lang.video.providers + '</small></label>' +
          '<input className="note-video-url form-control span12" type="text" />' +
          '</div>';
      var footer = '<button href="#" className="btn btn-primary note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
