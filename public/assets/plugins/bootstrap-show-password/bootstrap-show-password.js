...
!function ($) {
    ...
    Password.prototype.init = function() {
        ...
        this.$element.wrap(sprintf('<div className="%s input-group" />', inputClass));

        this.$text = $('<input type="text" />')
            [placementFuc](this.$element)
            .attr('className', this.$element.attr('className'))
        ...
        this.$icon = $([
            '<span tabindex="100" title="' + this.options.message + '" className="add-on input-group-addon">',
            '<i className="icon-eye-open' + (this.options.white ? ' icon-white' : '') +
