...
this,a=this.s.dt,d=g.actions,f=[];e.each(d,function(b,d){d.available(a,c)&&f.push(b)});if(1===f.length&&!1===this.c.alwaysAsk){var l=d[f[0]].execute(a,c);this._update(l,c)}else{var h=this.dom.list.children("ul").empty();f.push("cancel");e.each(f,function(f,l){h.append(e("<li/>").append('<div className="dt-autofill-question">'+d[l].option(a,c)+"<div>").append(e('<div className="dt-autofill-button">').append(e('<button className="'+g.classes.btn+'">'+a.i18n("autoFill.button","&gt;")+"</button>").on("click",function(){var f=
