...
sweetAlert.close = swal.close = function () {
  ...
  // Reset custom className (delay so that UI changes aren't visible)
  setTimeout(function () {
    var customClass = modal.getAttribute('data-custom-className');
...
var setParameters = function setParameters(params) {
  ...
  if (params.customClass) {
    ...
    modal.setAttribute('data-custom-className', params.customClass);
  } else {
    // Find previously set classes and remove them
    var customClass = modal.getAttribute('data-custom-className');
    (0, _handleDom.removeClass)(modal, customClass);
    modal.setAttribute('data-custom-className', '');
  }
