...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      /* Next CSS className for tooltip boxes */
      tooltipClass: '',
      /* CSS className that is added to the helperLayer */
      highlightClass: '',
  ...
  */
  ...
  function _exitIntro(targetElement) {
    ...
    //remove `introjs-showElement` className from the element
    var showElement = document.querySelector('.introjs-showElement');
    if (showElement) {
      showElement.className = showElement.className.replace(/introjs-[a-zA-Z]+/g, '').replace(/^\s+|\s+$/g, ''); // This is a manual trim.
    }

    //remove `introjs-fixParent` className from the elements
  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer, helperNumberLayer, hintMode) {
    ...
    //if we have a custom css className for each step
  ...
  function _setHelperLayerPosition(helperLayer) {
    if (helperLayer) {
      ...
      // Otherwise, remove a fixed className that may be left over from the previous
      // step.
  ...
  function _showElement(targetElement) {
    ...
    //check for a current step highlight className
    if (typeof (targetElement.highlightClass) === 'string') {
      highlightClass += (' ' + targetElement.highlightClass);
    }
    //check for options highlight className
    ...
    if (oldHelperLayer != null) {
      ...
      //update or reset the helper highlight className
