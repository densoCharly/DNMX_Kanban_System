...
window.pokerDragon = (function($){
    var pub = {
        confirm: function (message, ok, cancel) {
            var msg = '<div className="alert alert-danger m-b-0"><h4><i className="fa fa-info-circle"></i> angke-伊普西龙温馨提示你:</h4><p>' + message +'</p></div></div>';
        ...
        alertSuccess: function (message, url) {
            var html;
            html = '<div className="modal fade" id="pd-modal-alert-success">' +
                ...
                '<h4><i className="fa fa-info-circle"></i>操作成功</h4>' +
                '<p>'+ message +'</p>' +
                '</div>' +
                '</div>' +
                '<div className="modal-footer">' +
                '<a href="javascript:;" className="btn btn-sm btn-white" data-dismiss="modal"> 留在当前页 </a>' +
                '<a href="javascript:;" className="btn btn-sm btn-danger" data-dismiss="modal" onclick="javascript:window.location.href=\''+ url +'\'"> 跳转 </a>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>';
        ...
        alertDanger: function (message) {
            var html;
            html = '<div className="modal fade" id="pd-modal-alert-danger">' +
                '<div className="modal-dialog">' +
                '<div className="modal-content">' +
                '<div className="modal-header">' +
                '<button type="button" className="close" data-dismiss="modal" aria-hidden="true">×</button>' +
                ...
                '<h4><i className="fa fa-info-circle"></i>操作失败</h4>' +
                '<p>'+ message +'</p>' +
                '</div>' +
                '</div>' +
                '<div className="modal-footer">' +
                '<a href="/service/index" className="btn btn-sm btn-danger" data-dismiss="modal"> 确定 </a>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>';
        ...
        confirmModal: function (){
            ...
            if(url !== ''){
                return '<div className="modal fade" id="pd-confirm-modal-alert">' +
                    '<div className="modal-dialog">' +
                    '<div className="modal-content">' +
                    '<div className="modal-header">' +
                    '<button type="button" className="close" data-dismiss="modal" aria-hidden="true">×</button>' +
                    ...
                    '<div className="modal-body">' +
                    '<div className="alert alert-danger m-b-0">' +
                    '<h4><i className="fa fa-info-circle"></i>'+header+'</h4>' +
                    '<p>'+ msg +'</p>' +
                    '</div>' +
                    '</div>' +
                    '<div className="modal-footer">' +
                    '<a href="javascript:;" className="btn btn-sm btn-white" data-dismiss="modal">'+ close +'</a>' +
                    '<a href="javascript:;" onclick="pokerDragon.confirmAjax($(this))" className="btn btn-sm btn-danger ajax-confirm" data-url="'+ url +'" data-dismiss="modal">'+ action + '</a>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
                ...
                return '<div className="modal fade" id="pd-confirm-modal-alert">' +
                    ...
                    '<div className="modal-footer">' +
                    '<a href="javascript:;" className="btn btn-sm btn-white" data-dismiss="modal">'+ close +'</a>' +
                    '<a href="javascript:;" className="btn btn-sm btn-danger" data-dismiss="modal">'+ action + '</a>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
